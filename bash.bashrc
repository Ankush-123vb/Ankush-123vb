...
# Display "ANKUSH" Banner
echo -e "${CYAN} █████╗ ███╗   ██╗██╗   ██╗██╗   ██╗███████╗██╗  ██╗ ${RESET}"
echo -e "${CYAN}██╔══██╗████╗  ██║██║   ██║██║   ██║██╔════╝██║  ██║ ${RESET}"
echo -e "${CYAN}███████║██╔██╗ ██║██║   ██║██║   ██║███████╗███████║ ${RESET}"
echo -e "${CYAN}██╔══██║██║╚██╗██║██║   ██║██║   ██║╚════██║██╔══██║ ${RESET}"
echo -e "${CYAN}██║  ██║██║ ╚████║╚██████╔╝╚██████╔╝███████║██║  ██║ ${RESET}"
echo -e "${GREEN}Welcome to the Ankush Termux Theme!${RESET}\n"

# Custom Prompt with Username, Host, and Directory
PS1="\[\e[31m\]Ankush@\h \[\e[34m\]\w\[\e[33m\] \$ \[\e[0m\]"

# Custom Aliases for Quick Commands
alias cls='clear'
alias ll='ls -la --color=auto'
alias update='apt update && apt upgrade -y'
alias editbash='nano /data/data/com.termux/files/usr/etc/bash.bashrc'
...
# Greeting Message
echo -e "${YELLOW}Type ${WHITE}update${YELLOW} to update Termux!${RESET}"
